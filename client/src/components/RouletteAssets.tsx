...
export function NowPlayingTicketIcon() {
  return (
    <svg className="now-playing-ticket-svg" viewBox="0 0 104 72" aria-hidden="true">
      <defs>
        <linearGradient id="ticketActionGradient" x1="8" y1="8" x2="96" y2="64">
          <stop stopColor="#ff4f6d" />
          <stop offset="0.55" stopColor="#ffb84d" />
          <stop offset="1" stopColor="#ffe760" />
        </linearGradient>
      </defs>
      <path d="M10 14 Q10 8 16 8 H88 Q94 8 94 14 V22 Q86 25 86 36 Q86 47 94 50 V58 Q94 64 88 64 H16 Q10 64 10 58 V50 Q18 47 18 36 Q18 25 10 22 Z" fill="url(#ticketActionGradient)" />
      <path d="M23 14 V58" stroke="#08090d" strokeOpacity=".55" strokeWidth="2" strokeDasharray="4 4" />
      <rect x="29" y="15" width="52" height="42" rx="9" fill="#08090d" opacity=".86" />
      <text x="55" y="34" textAnchor="middle" fill="#fff4d0" fontSize="15" fontWeight="950">NOW</text>
      <text x="55" y="49" textAnchor="middle" fill="#ffbf34" fontSize="13" fontWeight="950">PLAYING</text>
    </svg>
  );
}
  ...
  return (
    <svg className="tap-to-spin-poster-svg" viewBox="0 0 360 540" aria-hidden="true">
      <defs>
        ...
        <linearGradient id="tapTicketGradient" x1="12" y1="8" x2="100" y2="108">
          <stop stopColor="#ff4f6d" />
          <stop offset=".56" stopColor="#ffb84d" />
          <stop offset="1" stopColor="#ffe760" />
        </linearGradient>
      </defs>
      ...
      <g transform="translate(124 116)">
        <circle cx="56" cy="56" r="50" fill="url(#tapTicketGradient)" />
      ...
      <text x="180" y="358" textAnchor="middle" fill="#fff7df" fontSize={empty ? "34" : "30"} fontWeight="950">{empty ? "NO MOVIES" : "TAP TO CHOOSE"}</text>
      <text x="180" y="398" textAnchor="middle" fill="#ffe7b8" fontSize="20" fontWeight="800">{empty ? "LOADED" : "TONIGHT'S MOVIE"}</text>
