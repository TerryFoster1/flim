...
export const TRICERATOPS_LEVEL_CONFIG_VERSION = "2026-08-15-traversal-reset-v4";
...
export const triceratopsGameConfig = {
  ...
  world: {
    ...
    longJumpVelocity: 430,
    longJumpMs: 640,
    longJumpSpeedMultiplier: 1.58,
    slideMs: 820,
    coyoteMs: 240,
    inputBufferMs: 420,
  ...
  timeline: [
    ...
    },
    {
      ...
      tutorial: "Jump onto the dumpster",
      points: 120,
      platform: true,
    },
    {
    ...
    },
    {
      ...
      distance: 1510,
      label: "1-UP",
      tutorial: "Second tap left while airborne to reach the 1-UP",
      points: 750,
    ...
    },
    {
      ...
      distance: 3090,
      label: "Camera crane",
      tutorial: "Double tap right to slide",
      points: 180,
      telegraph: "duck",
      lane: "overhead",
    },
    {
      ...
      distance: 3480,
      label: "Long-jump pit",
      tutorial: "Jump, press left again, and hold",
      points: 260,
      telegraph: "wide gap",
    },
    {
    ...
    },
    {
      ...
      chainStep: 5,
      chainBonus: 250,
      tutorial: "Rampage ready: double tap right",
      points: 500,
    },
    {
      id: "breakaway-flat",
