...
const fallbackTemplates: Record<string, string> = {
  ...
  cbc_gem: "https://gem.cbc.ca/search?query={title}",
  cineplex: "https://store.cineplex.com/search?query={title}",
  crave: "https://www.crave.ca/en/search?query={title}",
  criterion: "https://www.criterionchannel.com/search?q={title}",
  disney: "https://www.disneyplus.com/search?q={title}",
  google_tv: "https://tv.google.com/search/{title}",
  hoopla: "https://www.hoopladigital.com/search?q={title}&scope=everything&type=direct",
  ...
  shudder: "https://www.shudder.com/search?search={title}",
