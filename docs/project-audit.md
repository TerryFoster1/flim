...
| Branding/logo/favicon | Complete | `client/public/brand/flim-logo-primary.png`, `client/public/brand/flim-icon-mark-source.png`, `client/public/favicon.ico`, `client/index.html`, `client/src/components/BrandMark.tsx`, `docs/branding.md` | The official primary logo is used in the web header; the secondary icon mark is documented for favicon/PWA/mobile icon contexts. | Social preview images are static and may not be playlist-specific. | Add generated playlist Open Graph images later. | Yes |
